...
//   page    clamp(30,4.4vw,50) → 30 / md 40 / lg 50   (education + events + article heroes)
//   feature clamp(24,3vw,34)   → 24 / md 30 / lg 34   (featured-card titles)
//   section clamp(26,4vw,44)   → 26 / md 31 / lg 41 / xl 44
//   stat    clamp(54,7vw,82)   → 54 / lg 72 / xl 82
//   card    18–19px
type Size = "hero" | "page" | "feature" | "section" | "stat" | "card";

const sizes: Record<Size, string> = {
  hero: "text-[40px] md:text-[51px] lg:text-[68px] xl:text-[78px] font-bold uppercase leading-[0.95] tracking-[-1.7px]",
  page: "text-[30px] md:text-[40px] lg:text-[50px] font-bold leading-[1.08] tracking-[-1px]",
  feature: "text-[24px] md:text-[30px] lg:text-[34px] font-bold leading-[1.1]",
  section:
