      ...
      <Container className="absolute inset-x-0 bottom-0 pb-12 md:pb-16">
        <Reveal>
          <div className="flex items-end justify-between gap-6 border-t border-white/25 pt-6">
            <p className="max-w-[26ch] font-oswald text-[24px] font-bold uppercase leading-[1.05] tracking-[-0.3px] text-white sm:text-[34px] lg:text-[40px]">
              From the coast to the outback —
              <span className="text-gold"> your trip starts here.</span>
            </p>
